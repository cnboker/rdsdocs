...
## Create Dashboard for ARM

* Create YAML file(e.g., 'kubernetes-dashboard-arm.yaml') with the following content:
...
```bash
kubectl apply -f kubernetes-dashboard-arm

```

## Create service-account.yaml YAML

* Create YAML file(e.g., 'service-account.yaml') with the following content:
...
## Create cluster-role.yaml YAML

* Create another YAML file(e.g., 'cluster-role.yaml') whith the following content:
...
## Create dashboard-traefik

* Create another YAML file(e.g., 'dashboard-traefik.yaml') whith the following content:
